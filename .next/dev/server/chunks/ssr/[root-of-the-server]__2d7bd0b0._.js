...
(()=>{
    const e = new Error("Cannot find module '@/components/BlogManager'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/CategoryManager'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/LinkManager'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/ColorManager'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
"use client";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d7bd0b0._.js.map
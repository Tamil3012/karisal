...
"[project]/lib/file-utils.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/admin/links/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/file-utils.ts [app-route] (ecmascript)");
...
async function POST(request) {
    ...
    try {
        ...
        const links = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readJsonFile"])("links.json");
        const newLink = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateId"])(),
            title,
            href,
            createdAt: new Date().toISOString()
        };
        links.push(newLink);
        const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeJsonFile"])("links.json", links);
        if (!success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__db8e0ec6._.js.map